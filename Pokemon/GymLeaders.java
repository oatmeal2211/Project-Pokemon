...
public class GymLeaders {
    ...
    public GymLeaders() {
        ...
        ceruleanLeader.addPokemon(new Pokemon("Staryu","Water","None",30,45,55,70,70,85,18));
        ...
        saffronCityLeader.addPokemon(new Pokemon("Abra","Psychic","None",25,20,15,105,105,90,38));
